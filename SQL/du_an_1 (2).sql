...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 28, 2023 lúc 02:44 PM
...
(4, 'Giáo Dục', 7, 130000, 188000, 'Truyện ngắn thường chỉ tập trung vào một tình huống, một chủ đề nhất định. Trong khi đó, tiểu thuyết chứa được', '', 1),
(7, 'Tiểu Thuyết', 5, 210000, 248000, '', '', 1),
(10, 'Chủ đề âm nhạc', 4, 300000, 40000, 'Truyện ngắn thường chỉ tập trung vào một tình huống, một chủ đề nhất định. Trong khi đó, tiểu thuyết chứa được', '', 1),
(12, 'Thiếu nhi', 6, 120000, 140000, '', '', 1),
(13, 'Nấu ăn', 9, 130000, 150000, '', '', 1);
...
(40, 'Những Nhạc Khúc Hay Và Dễ Soạn Cho Đàn Piano (Tái ', 'Theo Bộ Giáo dục và Đào tạo Việt Nam, đến năm học 2020 – 2021, cả nước có 42.080 cơ sở giáo dục từ n', '331.jpg', 145000, 185000, 444, 132, 11, '2023-12-01', '23', 3, '2023-11-28', 10, 2, 1),
(41, '36 Ngày Biết Đệm Guitar - Kèm CD (Tái Bản 2016)', 'Theo Bộ Giáo dục và Đào tạo Việt Nam, đến năm học 2020 – 2021, cả nước có 42.080 cơ sở giáo dục từ n', '22345.jpg', 85000, 149000, 222, 213, 11, '2023-11-04', '23', 1313, '2023-11-28', 10, 2, 1),
(42, '45 Ngày Biết Đệm Guitar - Tiết Điệu: Slow Fox-Disc', 'Theo Bộ Giáo dục và Đào tạo Việt Nam, đến năm học 2020 – 2021, cả nước có 42.080 cơ sở giáo dục từ n', 'amnhac.jpg', 130000, 159000, 230, 145, 11, '2023-08-16', '23', 3, '2023-11-28', 10, 2, 1),
...
(29, 'admin@admin.com', '123', NULL, 'duong', 'user.jpg', 2, 1),
(30, 'phunhph33261@fpt.edu.vn', '123', '0962954690', 'Phú Nguyễn', 'user.jpg', 1, 1);
...
--
ALTER TABLE `anh_san_pham`
  MODIFY `id_anh_san_pham` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=124;
...
--
ALTER TABLE `chi_tiet_don_hang`
  MODIFY `id_chi_tiet_don_hang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT cho bảng `dia_chi`
--
ALTER TABLE `dia_chi`
  MODIFY `id_dia_chi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `gio_hang`
  MODIFY `id_gio_hang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT cho bảng `ho_don`
--
ALTER TABLE `ho_don`
  MODIFY `id_hoa_don` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `san_pham`
  MODIFY `id_san_pham` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
