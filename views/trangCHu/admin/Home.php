                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php echo number_format(100000000000, 0, ',', ','); ?>
                            </div>
                        </div>
                        <div class="col-auto">
                                ...
                                <div class="col">
                                    <div class="progress progress-sm mr-2">
                                        <div class="progress-bar bg-info" role="progressbar"
                                            style="width: <?php echo  round(80 / 88 * 100, 2); ?>%" aria-valuenow="50"
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 text-center small">
                        <span class="mr-2">
                            <i class="fas fa-circle text-primary"></i> <?php echo 'sp1' ?>
                        </span>
                        <span class="mr-2">
                            <i class="fas fa-circle text-success"></i> <?php echo 'sp2' ?>
                        </span>
                        <span class="mr-2">
                            <i class="fas fa-circle text-info"></i> <?php echo 'sp3' ?>
                        </span>
                    </div>
                </div>
            </div>
